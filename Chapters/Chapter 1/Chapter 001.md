...
<img 
  src="./img/001.png" 
  width="800" 
  alt="Diagrama de las actividades del negocio: financiamiento (acreedores y dueños), inversión (contratistas de edificios y equipos) y operación (clientes y proveedores), todas conectadas a la empresa central. | Business activities diagram: financing (creditors and owners), investing (building and equipment contractors), and operating (customers and suppliers), all connected to the central company."
  title="Business Activities - Actividades del Negocio"
  data-description="La imagen muestra un diagrama con 'Company' en el centro. Arriba conecta con 'Creditors and/or Owners' mediante flechas de financiamiento. A la izquierda o derecha conecta con 'Building and Equipment Contractors' mediante flechas de inversión. Abajo o al otro lado conecta con 'Customers and Suppliers' mediante flechas bidireccionales de operación.">
...
<img 
  src="./img/002.png" 
  width="800" 
  alt="Diagrama de flujo contable de 5 pasos: 1) Identificar usuarios (internos: gerentes y empleados; externos: inversores, acreedores, clientes y gobierno), 2) Evaluar necesidades de información, 3) Diseñar sistema contable, 4) Registrar datos económicos, 5) Preparar informes contables. | 5-step accounting flow diagram: 1) Identify users (internal: managers and employees; external: investors, creditors, customers, government), 2) Assess information needs, 3) Design accounting system, 4) Record economic data, 5) Prepare accounting reports."
  title="Accounting as an Information System - La Contabilidad como Sistema de Información"
  data-description="La imagen muestra un proceso vertical de 5 pasos. En el paso 1, los usuarios se dividen en internos (gerentes y empleados) y externos (inversores, acreedores, clientes y gobierno). Luego sigue con evaluar necesidades, diseñar el sistema, registrar datos y preparar informes.">
